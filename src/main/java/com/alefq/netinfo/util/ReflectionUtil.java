...
public class ReflectionUtil {
	...
	public static Object callGetter(Object bean, String fieldName)
		...
		try {
			...
			// por ahora sólo me interesa el valor, cualquier otra excecpción la
			// wrappeo
	...
	public static String callGetterDynamic(Object bean, String campo,
		...
		try {
			...
			throw new IllegalStateException("No se pudo obtener el método : "
					+ nombreMetodo, e);
		}
		return ret;
	}
	...
	public static void callSetter(Object bean, String fieldName, Object valor)
		...
		try {
			...
			// por ahora sólo me interesa llamar al getter, cualquier otra
			// excepción la wrappeo
			throw new IllegalStateException(e);
		}
	}
	...
	/**
	 * Busca el {@link Field} en la clase y en todos sus ancestros, hasta llegar
	 * a la clase {@link Object}. Si no encuentra el campo, devuelve <code>null</code>
	 * 
	 * @param fieldName
	 * @param resultClass
	 * @return
	...
	public static Method getMethod(Object bean, String nombre,
		...
		try {
			...
			log.debug("No se pudo obtener el método", e);
			ret = null;
		}
		return ret;
	}
	 ...
	 * que reciba un String como parámetro
	 * 
	 * @param tipo
	 * @param valor
	 * @return
	...
	public static Map<Integer, String> salidaComandoPorLinea(String cmdline) {
		...
		try {
			...
			log.error("Fallo la ejecución del comando:" + cmdline);
		}
		return ret;
	}

	/**
	 * Verifica que TODA la lista de campos tengan algún valor distinto de null
	 * cargado O si son String que no están vacíos
	 * 
	 * @param oferente
